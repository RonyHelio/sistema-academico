...
BEGIN
    ...
    SELECT mtr_nr_id INTO v_mtr1 FROM academico.mtr_matricula_turma WHERE alu_nr_id = v_alu1_id AND tur_nr_id = 1;
    SELECT mtr_nr_id INTO v_mtr2 FROM academico.mtr_matricula_turma WHERE alu_nr_id = v_alu1_id AND tur_nr_id = 2;
    SELECT cht_nr_id INTO v_cht1 FROM academico.cht_chat_turma WHERE tur_nr_id = 1;
    SELECT cht_nr_id INTO v_cht2 FROM academico.cht_chat_turma WHERE tur_nr_id = 2;
    ...
    INSERT INTO academico.usu_usuario (usu_tx_nome, usu_tx_email, usu_tx_login, usu_tx_senha, usu_tx_perfil, usu_tx_status)
    VALUES ('João Silva', 'joao@campus.edu.br', 'joao', '123456', 'ALUNO', 'A') RETURNING usu_nr_id INTO v_usu_joao;
    ...
    VALUES (v_usu_joao, 1, '20261002', 'A') RETURNING alu_nr_id INTO v_alu_joao;

    INSERT INTO academico.alu_aluno (usu_nr_id, cur_nr_id, alu_tx_matricula, alu_tx_status)
    VALUES (v_usu_ana, 1, '20261003', 'A') RETURNING alu_nr_id INTO v_alu_ana;
    ...
    VALUES (v_dis_bd, v_pro_maria, 1, 'Turma A - Banco de Dados 2026.1', 'SUAP-TURMA-03', 'A') RETURNING tur_nr_id INTO v_tur_bd;
    ...
    VALUES (v_alu_joao, 1, 'A') RETURNING mtr_nr_id INTO v_mtr3;

    INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status)
    VALUES (v_alu_joao, 2, 'A') RETURNING mtr_nr_id INTO v_mtr4;

    INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status)
    VALUES (v_alu_ana, 1, 'A') RETURNING mtr_nr_id INTO v_mtr5;
