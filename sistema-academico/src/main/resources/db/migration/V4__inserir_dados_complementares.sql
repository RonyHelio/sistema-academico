...
INSERT INTO academico.usu_usuario (usu_tx_nome, usu_tx_email, usu_tx_login, usu_tx_senha, usu_tx_perfil, usu_tx_status)
VALUES ('João Silva', 'joao@campus.edu.br', 'joao', '123456', 'ALUNO', 'A');
...
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (2, 1, 'A');
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (2, 2, 'A');
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (3, 1, 'A');
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (3, 3, 'A');
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (1, 3, 'A');
INSERT INTO academico.mtr_matricula_turma (alu_nr_id, tur_nr_id, mtr_tx_status) VALUES (1, 4, 'I');
...
INSERT INTO academico.fal_falta (mtr_nr_id, fal_dt_data, fal_nr_quantidade, fal_tx_observacao, fal_tx_status) VALUES (1, '2026-03-10', 2, 'Ausência justificada', 'A');
...
INSERT INTO academico.fal_falta (mtr_nr_id, fal_dt_data, fal_nr_quantidade, fal_tx_observacao, fal_tx_status) VALUES (3, '2026-02-20', 2, 'Atestado médico', 'A');
...
INSERT INTO academico.fal_falta (mtr_nr_id, fal_dt_data, fal_nr_quantidade, fal_tx_observacao, fal_tx_status) VALUES (6, '2026-04-15', 2, 'Consulta médica', 'A');
...
VALUES (1, 2, 'Bem-vindos à disciplina de Estrutura de Dados!', '2026-02-10 08:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (1, 3, 'Obrigado, professor! Quando será a primeira prova?', '2026-02-10 09:15:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (1, 2, 'A primeira prova será na semana 8. Fiquem atentos ao cronograma.', '2026-02-10 10:30:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (1, 5, 'Professor, o trabalho pode ser feito em dupla?', '2026-02-12 14:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (1, 2, 'Sim, pode ser em dupla ou individual.', '2026-02-12 15:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (1, 3, 'Mensagem removida pelo autor.', '2026-02-13 08:00:00', 'I');

INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (2, 2, 'Olá turma! Nosso projeto web será desenvolvido ao longo do semestre.', '2026-02-11 08:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (2, 3, 'Professor, podemos usar React?', '2026-02-11 10:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (2, 2, 'Sim, React ou Angular são permitidos.', '2026-02-11 11:30:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (2, 5, 'Teste de mensagem inativa.', '2026-02-14 09:00:00', 'I');

INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (3, 4, 'Bem-vindos ao chat de Banco de Dados!', '2026-02-12 08:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (3, 6, 'Bom dia, professora! Estou animada para a disciplina.', '2026-02-12 09:00:00', 'A');
INSERT INTO academico.msg_chat_mensagem (cht_nr_id, usu_nr_id, msg_tx_mensagem, msg_dt_envio, msg_tx_status)
VALUES (3, 4, 'Vamos trabalhar bastante com SQL neste semestre.', '2026-02-12 10:00:00', 'A');
